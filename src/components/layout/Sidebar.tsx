...
import { User, Shield, Users, Wallet, Building2, History, LayoutDashboard, Image, Settings, Info } from "lucide-react";
...
export function Sidebar() {
    ...
    const navItems = [
        ...
        { href: "/dashboard/personalization", label: "Personalization", icon: Image },
